...
var jspang1 = '技术胖';
var jspanga1 = new String("jspang.com");
console.log(jspang1);
console.log(jspanga1);
console.log('-----------------我是分割线-----------------');
console.log("2. 字符串的长度length");
var jspang2 = '技术胖';
var jspanga2 = new String("jspang.com");
...
var something1 = "清早起来打开窗，心情美美的，我要出去找小姐姐，心情美美的。";
var xiaoJieJie1 = "小姐姐";
console.log(something1.indexOf(xiaoJieJie1)); //19
// 如果没有查找到字符串 就会返回-1
// 2. 从字符串尾部开始查找字符串第一个符合字符串的位置，使用lastIndexOf( )
var something2 = "清早起来打开窗，心情美美的，我要出去找小姐姐，心情美美的对对对。";
var xiaoJieJie2 = "小姐姐";
