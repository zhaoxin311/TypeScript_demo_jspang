...
function search1(age:number,stature?:string):string {
  let yy:string=''
  yy='找到'+age+'岁'
...
var result:string=search1(22,'瘦瘦的')
console.log(result);

console.log('-----------------我是分割线-----------------');

console.log('2. 有默认参数的函数');
function search2(age:number=19,stature:string='高高的'):string {
  let yy:string=''
  yy='找到'+age+'岁'
  if(stature!=undefined){
    yy=yy+stature
...
var result:string=search3('19岁','白的','高的','瘦瘦的','美美的')
console.log(result);
